...
<!--    --><?php //} ?>
    <div class="customer_list">
        <ul class="customer_list_ul">
            ...
            <a href="<?= Url::to(['user/orders']) ?>"><li><img src="/svg/My_orders.svg" alt=""> My orders (3)</li></a>
            <?php if (Yii::$app->user->identity->role == 1) { ?>
            <a href="<?= Url::to(['user/products']) ?>"><li><img src="/svg/My_orders.svg" alt=""> My products (1)</li></a>
            <?php } ?>
