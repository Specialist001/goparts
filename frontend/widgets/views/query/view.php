...
<section class="widgetform">
    <form method="GET" action="<?= Url::to(['query/create', 'car_id'=>$car_id])?>" class="widgetform_form">
<!--    <form method="POST" action="--><?//= Url::current()?><!--" class="widgetform_form">-->
...
//                                print_r($key);
            ...
            <div class="widgetform_button float-md-left d-inline-block">
                <button type="submit" class="button"><img src="/svg/search.svg" alt=""> <span>Search</span></button>
            </div>
        </div>
