...
class m190517_125134_create_posts_table extends Migration
{
    ...
    public function safeUp()
    {
        ...
        //$this->createIndex('ix_posts_status', '{{%posts}}', 'status', false);
    ...
    {
        $this->dropIndex('ix-posts_blog_id', '{{%posts}}', 'blog_id', false);
        $this->dropIndex('ix-posts_category_id', '{{%posts}}', 'category_id', false);
        $this->dropIndex('ix-posts_create_user_id', '{{%posts}}', 'create_user_id', false);
        $this->dropIndex('ix-posts_update_user_id', '{{%posts}}', 'update_user_id', false);
        $this->dropIndex('ix-posts_access_type', '{{%posts}}', 'access_type', false);
        //$this->dropIndex('ix-posts_status', '{{%posts}}', 'status', false);
        $this->dropIndex('ix-posts_comment_status', '{{%posts}}', 'comment_status', false);
        $this->dropIndex('ix-posts_lang', '{{%posts}}', 'lang', false);
        $this->dropIndex('ix-posts_slug', '{{%posts}}', 'slug', false);
        $this->dropIndex('ix-posts_published_at', '{{%posts}}', 'published_at', false);
